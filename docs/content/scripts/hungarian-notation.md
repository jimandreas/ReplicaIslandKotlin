---
title: "Hungarian Notation Conversion Script"
date: 2025-01-01
draft: false
---

# Hungarian Notation Conversion Script

This bash script was used to convert Hungarian notation member variables (e.g., `mSomething`) to standard Kotlin naming conventions (e.g., `something`) during the Kotlin conversion process.
